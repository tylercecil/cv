...
\begin{adjustwidth}{40pt}{40pt}
  ...
  \begin{itemize}
    ...
    \item I developed test frameworks for the Google Cloud Platform. Due to its
      complex parallel heterogeneous architecture, a holistic understanding of
      systems was required to make that happen, from the kernel, to the
      software defined network, and beyond.

    \item My project C compiler as well as research at a national laboratory
      touch a wide set of topics in CS, applying both theoretical knowledge
      of algorithms, as well as a low-level understanding of how they run on
      metal.

    \item As a developer I've been Linux-centric, utilizing experience in
      systems programing, operating system design, and computer architecture.

    \item I received a peer bonus for a stateless test configurator, which drew
      on my specialization in functional languages; something I've translated
      into a stack-independent appreciation for the craft of software.
