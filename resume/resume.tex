...
\begin{minipage}[t]{0.3\linewidth}
  ...
  Engaged in local political action groups, such as the California Bicycle
  Coalition and Access Fund, advocating for cycling policy and wildlife
  access preservation.
  % , aligning with, rock
  % climbing, backpacking, and bikepacking.
