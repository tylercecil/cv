...
\begin{minipage}{0.675\linewidth}
 ...
 {\Large \color{darkgray} {
   ...
   \noindent
   Software Engineer in Cloud Framework Testing
 }}
\end{minipage}
\hfill
\begin{tabular}{|rl}
...
\begin{multicols}{2}
  ...
  \subsection{Topics}
  Cloud Integration Testing, Software Design \& Testing, Algorithms, Functional
  Programming, OOP, Machine Learning, Compilers, Robotics, \ldots

  \vfill\null
  \columnbreak

  \subsection{Tools}
  Google Cloud Platform, Microcontrollers, Unix / Linux, Git, LLVM, Jupyter, \ldots
...
\begin{multicols}{2}
  ...
  \vspace{-.5em}
  \noindent
  $\bullet$ \textbf{ACM Chapter President, 2012-2016}

  \vspace{.5em}
  \noindent
  $\bullet$ \textbf{CSAW-CTF Finalist, 2012, 2013}

  \noindent
  $\bullet$ \textbf{MORT C89 Compiler}\\
  Implemented a C89 compiler in C++. Designed powerful SSA based IR,
  managed team work-flow, and used modern C++ design practices.\\

  \vspace{-.5em}
  \noindent
  $\bullet$ \textbf{FRC Robotics World Finalist, 2008}

  \vspace{.5em}
  \noindent
  $\bullet$ \textbf{ACM-ICPC 10th Place Regional, 2014}
